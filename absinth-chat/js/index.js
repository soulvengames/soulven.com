    ...
    function startIntroChat() {
        ...
        setTimeout(function() { chat.createChatMessage("The Chief Inspector you were talking to uses as password the alphabetical equivalent as number of the current month.", 1) }, 10000);
        setTimeout(function() { chat.createChatMessage("e.g. the password from January was: 10 1 14 21 1 18 25", 1) }, 15000);
